...
public class LoginDialogActivity extends AnyTimeActivity  implements LoginView, View.OnLayoutChangeListener {
...
//            activity.finish();
    ...
    public void setLoginSuccess(LoginBean mLoginBean, String logoinType) {
        if (mLoginBean.is_first()) {
            ...
            startActivity(new Intent(LoginDialogActivity.this, EmailActivity.class).putExtra("mLoginBean", mLoginBean));
        } else {
            UserInfos.setLoginBean(LoginDialogActivity.this, mLoginBean);
//            startActivity(new Intent(LoginDialogActivity.this, DeviceActivity.class));
            finish();
            overridePendingTransition(R.anim.fade, R.anim.hold);
        }
    ...
    public void setLoginFail(String errInfo) {
        if (!TextUtils.isEmpty(errInfo))
            Toast.makeText(LoginDialogActivity.this, errInfo, Toast.LENGTH_SHORT).show();
    }
