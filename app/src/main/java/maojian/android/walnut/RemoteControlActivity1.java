 ...
 */
public class RemoteControlActivity1 extends Activity {
    ...
    TextView remain_battery, tv_speed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remotecontrol1);
...
//                        lockmode = false;
                        ...
                        RemoteControlActivity1.this.setResult(Activity.RESULT_OK, intent_ui);
        ...
        Intent gattServiceIntent = new Intent(RemoteControlActivity1.this, BluetoothLeService.class);
                ...
                try {
                    ...
                    if (forward_progress <= 2) {
                        ...
                        mHandler.post(new Runnable() {
                            @Override
                            public void run() {
                                tv_speed.setTextColor(getResources().getColor(R.color.whiteColor));
                                tv_speed.setText("0");
...
//           }
    boolean lockLongVOLUME_DOWN = false;
    boolean lockLongVOLUME_up = false;
    ...
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            case KeyEvent.KEYCODE_VOLUME_UP:
                Log.v("TAG", "KEYCODE_VOLUME_UP long pressed");
                lockLongVOLUME_up = true;
                return true;

            case KeyEvent.KEYCODE_VOLUME_DOWN:
                Log.v("TAG", "KEYCODE_VOLUME_DOWN long pressed");
                lockLongVOLUME_DOWN = true;
                return true;
            default:
                break;
        }
